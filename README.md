...
This project loads a pre-trained RNN model and classifies a user-entered review as **Positive** or **Negative**. :contentReference[oaicite:0]{index=0}

---

## ✨ Features
- **Streamlit UI** to paste/type a movie review and classify it instantly :contentReference[oaicite:1]{index=1}  
